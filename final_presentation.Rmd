...
In our project we aim to analyze a set of variables affecting mostly all countries to elucidate which may be the most important factors affecting COVID-19 outbreak.
...
data02_clean <- read_tsv(file = "data/02_data_clean.tsv")
data02_clean
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE,fig.width=7.5, fig.height=5.5}
...
```{r, echo=FALSE, message=FALSE}
data_clean_aug %>% 
  ggplot(mapping = aes(x= Smoking, y = Deathsper100kpp)) + 
